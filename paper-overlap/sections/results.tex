...
\\\\Where $Q_{:o} = Q_1\uplus Q_2\uplus Q_1\times Q_2$, $P_{:o} = \textbf{P}_1\cup\textbf{P}_2$, $X_{:o} = \textbf{X}_1\cup\textbf{X}_2$ and:
\\ \( \Delta_{:o} = \{(q,P_1,L_1,(q',p_0))\mid (q,P_1,L_1,q')\in \Delta_1, (q,p_0) \in Q_1\times Q_2\} \cup 
\\ \{((q,p),P_1\land P_2, L_1\cup L_2, (q',p')) \mid (q,P_1,L_1,q')\in \Delta_1, (p,P_2,L_2,p')\in \Delta_2, (q,p), (q', p')\in Q_1 \times Q_2 \} \cup 
\\ \{((q,p),P_2,L_2,p') \mid q\in F_1, (p,P_2,L_2,p') \in \Delta_2\} \uplus\Delta_1\uplus\Delta_2 \)
...
\land C_2 \in \text{\textlbrackdbl} \varphi_2 \text{\textrbrackdbl}(\bar{S})$. We now prove that $C = C_1 \cup C_2$ or equivalently, because start($C) =  \text{min}\{\text{start}(C_1$),start($C_2$)\}, end($C) = \text{max}\{\text{end}(C_1$), end($C_2$)\}, we are left to prove that $C(X) = C_1(X) \cup C_2(X)$ for every $X \in \textbf{X}$.
\\\\
